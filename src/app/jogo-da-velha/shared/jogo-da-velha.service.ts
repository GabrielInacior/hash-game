...
/* Inicializa o jogo, definindo a exibição da tela inicial */
  inicializar() {
...
/* Inicializa o tabuleiro, definindo como vazio todas as posições */
...
/* Verifica e retorna se o jogo terminou */
 ...
 /* Logica para simular jogada da CPU em modo aleatorio */
  cpuJogar(): void {
  ...
  /* Obtem uma jogada valida para a vitória de um jogador */
